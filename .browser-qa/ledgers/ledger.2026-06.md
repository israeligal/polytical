...
| 2026-06-09 | fabb59a | mobile 390px `/notifications` + `/` header overflow | ⚠️ | 200px h-overflow from SiteHeader (~590px, no mobile collapse); IDENTICAL on untouched `/`; pre-existing, NOT a push regression; punch-list |
